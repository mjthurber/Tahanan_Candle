    ...
    return(
        <div>
            ...
            <Container className='mt-3'>
                <h2>Tahanan Candle Co. Privacy Policy</h2>
                ...
                <ul>
                    <li>
                        Companies who support our Site and Services, such as Shopify and Stripe.
                    </li>
                    <li>
                ...
                <h4>We have, in the past 12 months disclosed the following categories of personal information and sensitive personal information (denoted by *) about users for the purposes set out above in "How we Collect and Use your Personal Information" and "How we Disclose Personal Information":</h4>
                <h5>Category:</h5>
                <ul>
                    <li>
                ...
                <h5>Category of Personal Information:</h5>
                <ul>
                    <li>
                        Identifiers such as basic contact details and certain order and account information
                    </li>
